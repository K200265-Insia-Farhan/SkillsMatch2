...
// 		  `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getCompanyDetailsUsingId/${companyhrid}`,
// 		  {
// 			  headers: {
...
// 	try {
// 	  const response = await axios.get(
// 		`http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getCompanyProfilePictureUsingId/${companyhrid}`,
// 		{
// 		  headers: {
// 			Authorization: `Bearer ${localStorage.getItem("token")}`,
// 		  },
...
// 		const fullUrl = `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/${response.data.data.filePath}`;
...
// 		try {
// 		  const response = await axios.get(
// 			`http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getJobDetailsUsingId/${job_id}`,
// 			{
// 			  headers: {
// 				Authorization: `Bearer ${localStorage.getItem("token")}`,
// 			  },
...
// 			`http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/applyJob`,
//       data,
// 			{
// 			  headers: {
// 				Authorization: `Bearer ${localStorage.getItem("token")}`,
...
//       try {
//         const response = await axios.get(
//           "http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getJobsByCareerOfficers",
//           {
//             headers: {
//               Authorization: `Bearer ${localStorage.getItem("token")}`,
//             },
