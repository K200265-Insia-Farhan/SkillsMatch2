  ...
  useEffect(() => {
    // get job details by job_id
      ...
      try {
        ...
        `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getJobDetailsUsingId/${jobid}`,
        {
          headers: {
  ...
  const handleSaveClick = async () => {
    try {
      ...
      const response = await axios.put(
        `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/editJob/${jobid}`,
        jobDetails,
        {
          headers: {
