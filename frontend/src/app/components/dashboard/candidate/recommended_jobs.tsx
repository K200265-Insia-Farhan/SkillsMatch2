...
const CandidateRecommendedJobs = ({ setIsOpenSidebar }: IProps) => {
  ...
  useEffect(() => {
    const getRecommendations = async () => {
      try {
        const response = await axios.get(`http://a8befb311e9ac45ab93cf90c12edf9e6-880886542.us-east-1.elb.amazonaws.com:2003/recommend_jobs/${localStorage.getItem("candidate_id")}`);
