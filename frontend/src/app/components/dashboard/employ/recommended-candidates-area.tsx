      ...
      const getapplicants = async () => {
        try {
          const response = await axios.get(
            `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getApplicantsUsingJobId/${job_id}`,
            {
              headers: {
        ...
        const getRecommendedCandidates = async () => {
          try {
            ...
            //   console.log("recommended-candidates-area.tsx :: Recommended candidates: ", response.data);
              ...
              const candidateDetailsResponse = await axios.post('http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getCandidateDetailsUsingCandidateIdsArray', { candidateIds },
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                    },
