...
const CandidateAside = ({isOpenSidebar,setIsOpenSidebar}:IProps) => {
  ...
  const logoutCandidate = () => {
    ...
    if (role === 'candidate') {
      ...
      window.location.href = 'http://a72b221fb50cf4a169e83e7f64127bbd-484001430.us-east-1.elb.amazonaws.com:3000';
    }
  }
  ...
  useEffect(() => {
    const getUserDetails = async () => {
      try {
        ...
        const response = await axios.get('http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/candidateDetails', {
          headers: {
