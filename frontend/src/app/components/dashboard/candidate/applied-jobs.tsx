...
const AppliedJobsArea = ({setIsOpenSidebar}:IProps) => {
  ...
  const fetchAppliedJobs = async () => {
    try {
      ...
      const response = await axios.get(`http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getJobDetailsUsingCandidateId/${id}`,{
        headers: {
