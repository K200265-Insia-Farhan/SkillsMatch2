...
const DashboardProfileArea = ({ setIsOpenSidebar }: IProps) => {
    ...
    const getUserDetails = async () => {
      try {
        ...
        const responseCandidate = await axios.get(
          "http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/candidateDetails",
          {
            headers: {
        ...
        const responseInstitute = await axios.get(
          "http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getInstituteDetails",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        const responseWorkExperience = await axios.get(
          "http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getWorkExperienceDetails",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    const fetchProfilePicture = async () => {
      try {
        ...
        const response = await axios.get(
          'http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getProfilePicture',
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        if (response.status === 200) {
          ...
          const fullUrl = `http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000${response.data.filePath}`;
  ...
  const handleSaveClick = async () => {
    try {
      ...
      const response = await axios.put("http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/updateCandidateDetails", userDetails, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const createEducationResponse = await axios.post("http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/createCandidateEducationDetails", educationDetails, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const createWorkExperienceResponse = await axios.post("http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/createCandidateWorkExperience", workExperience, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
    ...
    if (file) {
      try {
        ...
        const uploadResponse = await axios.post(
          'http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/uploadProfilePicture',
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleResumeUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      try {
        ...
        // Send the file to the upload endpoint
        const uploadResponse = await axios.post(
          'http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/uploadResume',
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDownloadCV = async () => {
    try {
      ...
      const response = await axios.get(`http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000/api/auth/getResume?id=${id}`,{
        headers: {
          Authorization: `Bearer ${token}`
        }
      });

      const newPath = "http://a5fc17b29b02841ce84a49e511820394-1637568402.us-east-1.elb.amazonaws.com:5000" + response.data.filePath;
